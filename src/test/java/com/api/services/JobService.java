...
public class JobService {
	...
	public Response createJob(Role role, CreateJobPayload createJobPayload) {
		...
		LOGGER.info("Making request to the {} with the role {} and payload {}", CREATE_JOB_ENDPOINT , role, createJobPayload);
		return given()
	...
	public Response search(Role role, Object payload) {
		...
		LOGGER.info("Making request to the {} with the role {} and payload {}", SEARCH_ENDPOINT , role, payload);
