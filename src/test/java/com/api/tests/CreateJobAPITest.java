...
public class CreateJobAPITest {
	...
	public void setup() {
		...
		CustomerProduct customerProduct = new CustomerProduct(getTimeWithDaysAgo(10), "19700432156332", "19700432156332", "19700432156332", getTimeWithDaysAgo(10), Product.Nexus_2.getCode(), Model.NEXUS_2_BLUE.getCode());
