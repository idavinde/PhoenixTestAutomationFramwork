...
public class ExcelReaderUtil {
	...
	public static void main(String[] args) throws IOException {
		...
		InputStream input = Thread.currentThread().getContextClassLoader().getResourceAsStream("testData/PhoenixTestData.xlsx");
		...
		int lastIndexOfCol = rowHeader.getLastCellNum()-1; // return total no of col so we sub 1
